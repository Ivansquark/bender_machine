...
#define AFIO_PCFR9_TIM9_REMAP ((uint32_t)0x00000018) /*TIM9_REMAP*/
...
#define  RCC_TIM9EN                      ((uint32_t)0x00080000)         /* TIM1 Timer clock enable */
...
#define  RCC_TIM6EN                      ((uint32_t)0x00000010)        /* Timer 2 clock enabled*/
